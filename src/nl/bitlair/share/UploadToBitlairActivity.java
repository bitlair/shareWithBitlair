 ...
 * Copyright (C) 2011 M.Minderhoud <michiel1972@gmail.com>
   Altered by Juerd and Blokje for Bitlair
   Because we can :-)
...
public class UploadToBitlairActivity extends Activity {
	...
	private class UploadImageTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = ProgressDialog.show(UploadToBitlairActivity.this, "",
					"Please wait...", true);
		}
	    ...
	    public void onProgressUpdate(String... args){
	    	// nicelyEndApp(args[0]);
	    	Toast.makeText(UploadToBitlairActivity.this, args[0], Toast.LENGTH_LONG).show();
	    }
	    
	    @Override
	    protected void onPostExecute(Void result) {
	    	 mProgressDialog.dismiss();
	     	 Toast.makeText(UploadToBitlairActivity.this, endingMessage, Toast.LENGTH_LONG).show();
					...
					// Action starts after BUTTON click. Settings can not be changed anymore.
			         ...
			         buttonCancel.setOnClickListener(new View.OnClickListener() {
			             public void onClick(View v) {
			            	 ...
			            	 nicelyEndApp("Cancelled upload to Bitlair Wiki");
...
//		String domain = "bitlair.nl";
//		String scriptpath = "/";
//		
//		theWiki = new Wiki(domain, scriptpath);
//		
		theWiki.setDomain("wiki.bitlair.nl");
			...
			String detailinfo2, String licenseinfo2, String categorystring) {
		      return "==Summary==\n" +
				  "{{Information\n" +
					...
					"|other_versions=\n" +
					"}}\n" +
					"{{Images uploaded with Bitlair Share Android App}}\n" +
					"==Licensing==\n" +
					licenseinfo +"\n" +
					categorystring
					;
