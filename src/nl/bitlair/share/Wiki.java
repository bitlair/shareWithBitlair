...
public class Wiki implements Serializable
{
	...
	private UploadToBitlairActivity uplActivity;
     ...
     *  @since 0.02
     */
    public Wiki(UploadToBitlairActivity uplActivity)
    {
    	this("",uplActivity);
     ...
     *  en.wikipedia.org)
     */
    public Wiki(String domain, UploadToBitlairActivity uplActivity)
    {
    		                        ...
    		                        String reason) throws IOException, LoginException
    {
        ...
        try
        {
            ...
            uplActivity.setEndingMessage("Upload to Bitlair Wiki done!");
