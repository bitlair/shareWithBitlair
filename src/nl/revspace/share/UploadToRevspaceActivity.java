 ...
 * Copyright (C) 2011 M.Minderhoud <michiel1972@gmail.com>
   Altered by Juerd and Blokje for RevSpace
   Because we can :-)
...
public class UploadToRevspaceActivity extends Activity {
	...
	private class UploadImageTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = ProgressDialog.show(UploadToRevspaceActivity.this, "",
					"Please wait...", true);
		}
	    ...
	    public void onProgressUpdate(String... args){
	    	// nicelyEndApp(args[0]);
	    	Toast.makeText(UploadToRevspaceActivity.this, args[0], Toast.LENGTH_LONG).show();
	    }
	    
	    @Override
	    protected void onPostExecute(Void result) {
	    	 mProgressDialog.dismiss();
	     	 Toast.makeText(UploadToRevspaceActivity.this, endingMessage, Toast.LENGTH_LONG).show();
					...
					// Action starts after BUTTON click. Settings can not be changed anymore.
			         ...
			         buttonCancel.setOnClickListener(new View.OnClickListener() {
			             public void onClick(View v) {
			            	 ...
			            	 nicelyEndApp("Cancelled upload to RevSpace Wiki");
...
//		String domain = "revspace.nl";
//		String scriptpath = "/";
//		
//		theWiki = new Wiki(domain, scriptpath);
//		
		theWiki.setDomain("revspace.nl");
		theWiki.setScriptPath("");
		theWiki.setSchema("https");
		Log.d("Processupload", theWiki.getDomain());
		Log.d("Processupload", theWiki.base);
		//Connected?
		...
		Log.d("Processupload", "We hebben internetz");	
		//Try Login
			...
			String detailinfo2, String licenseinfo2, String categorystring) {
		      return "==Summary==\n" +
				  "{{Information\n" +
					...
					"|other_versions=\n" +
					"}}\n" +
					"{{Images uploaded with RevSpace Share Android App}}\n" +
					"==Licensing==\n" +
					licenseinfo +"\n" +
					categorystring
					;
